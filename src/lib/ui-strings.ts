...
const strings: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'A hardened warrior who wields powerful attacks and self-healing. Excels at strength-based strategies and exhausting cards for value.': { ja: '強力な攻撃と自己回復を武器にする戦士。筋力戦略とカード廃棄によるバリューに長ける。', ko: '강력한 공격과 자가 치유를 사용하는 전사. 힘 기반 전략과 카드 소멸에 뛰어남.', zh: '挥舞强力攻击与自愈的战士。擅长力量策略和消耗卡牌获取价值。', de: 'Ein gehärteter Krieger mit starken Angriffen und Selbstheilung. Spezialisiert auf Stärke-Strategien und Karten-Erschöpfung.', fr: 'Un guerrier endurci avec des attaques puissantes et l\'auto-guérison. Excelle dans les stratégies de force et l\'épuisement de cartes.', es: 'Un guerrero endurecido con ataques poderosos y autocuración. Destaca en estrategias de fuerza y agotamiento de cartas.', pt: 'Um guerreiro resistente com ataques poderosos e autocura. Excelente em estratégias de força e exaurir cartas.', it: 'Un guerriero temprato con attacchi potenti e autocura. Eccelle nelle strategie di forza e nell\'esaurimento delle carte.', pl: 'Zahartowany wojownik z potężnymi atakami i samoleczeniem. Specjalizuje się w strategiach siłowych i wyczerpywaniu kart.', ru: 'Закалённый воин с мощными атаками и самоисцелением. Мастер стратегий силы и сжигания карт.', tr: 'Güçlü saldırılar ve kendini iyileştirme kullanan savaşçı. Güç stratejileri ve kart tüketiminde uzman.', th: 'นักรบผู้ใช้การโจมตีอันทรงพลังและฟื้นฟูตัวเอง เชี่ยวชาญกลยุทธ์พลังและการสลายการ์ด' },
  'A deadly huntress who relies on poisons, shivs, and card draw. Focuses on discard synergies and stacking debuffs.': { ja: '毒、ナイフ、カードドローを駆使する暗殺者。捨て札シナジーとデバフ蓄積に特化。', ko: '독, 칼날, 카드 드로우에 의존하는 치명적인 사냥꾼. 버리기 시너지와 디버프 중첩에 집중.', zh: '依靠毒素、飞刀和抽牌的致命猎手。专注弃牌联动和叠加减益。', de: 'Eine tödliche Jägerin mit Gift, Dolchen und Kartenziehen. Fokus auf Abwurf-Synergien und Debuff-Stapelung.', fr: 'Une chasseuse mortelle utilisant poisons, couteaux et pioche. Spécialisée dans les synergies de défausse et l\'accumulation de débuffs.', es: 'Una cazadora letal que usa venenos, navajas y robo de cartas. Se enfoca en sinergias de descarte y acumulación de debuffs.', pt: 'Uma caçadora mortal que usa venenos, lâminas e compra de cartas. Foco em sinergias de descarte e acúmulo de debuffs.', it: 'Una cacciatrice letale che usa veleni, lame e pesca carte. Specializzata in sinergie di scarto e accumulo debuff.', pl: 'Śmiertelna łowczyni z truciznami, ostrzami i dobieraniem kart. Skupia się na synergiach odrzucania i kumulowaniu debuffów.', ru: 'Смертоносная охотница с ядами, клинками и добором карт. Фокус на синергии сброса и накоплении дебаффов.', tr: 'Zehir, bıçak ve kart çekmeye dayanan ölümcül avcı. Atma sinerjileri ve debuff biriktirmeye odaklanır.', th: 'นักล่าผู้พึ่งพาพิษ มีด และการดึงการ์ด เน้นซินเนอร์จีทิ้งการ์ดและสะสมดีบัฟ' },
  'An ancient automaton that channels elemental Orbs for passive and active effects. Unique focus on Lightning, Frost, Dark, and Plasma orbs.': { ja: 'エレメンタルオーブをチャネルする古代オートマトン。ライトニング、フロスト、ダーク、プラズマオーブに特化。', ko: '원소 오브를 채널링하는 고대 자동 기계. 번개, 서리, 어둠, 플라즈마 오브에 집중.', zh: '引导元素球体的古代机械。专注于闪电、冰霜、黑暗和等离子球体。', de: 'Ein uralter Automat, der elementare Orbs kanalisiert. Spezialisiert auf Blitz-, Frost-, Dunkel- und Plasma-Orbs.', fr: 'Un ancien automate qui canalise des Orbes élémentaires. Spécialisé dans les orbes Foudre, Givre, Ténèbres et Plasma.', es: 'Un autómata antiguo que canaliza Orbes elementales. Enfocado en orbes de Rayo, Escarcha, Oscuridad y Plasma.', pt: 'Um autômato antigo que canaliza Orbes elementais. Foco em orbes de Raio, Gelo, Escuridão e Plasma.', it: 'Un automa antico che incanala Sfere elementali. Specializzato in sfere Fulmine, Gelo, Buio e Plasma.', pl: 'Starożytny automat kanałujący żywiołowe Kule. Specjalizuje się w kulach Błyskawicy, Mrozu, Ciemności i Plazmy.', ru: 'Древний автоматон, направляющий стихийные Сферы. Специализация на сферах Молнии, Мороза, Тьмы и Плазмы.', tr: 'Elementel Küreleri kanalize eden antik otomat. Yıldırım, Buz, Karanlık ve Plazma kürelerine odaklanır.', th: 'หุ่นยนต์โบราณที่ชาแนลออร์บธาตุ เน้นออร์บสายฟ้า น้ำแข็ง มืด และพลาสม่า' },
  'A dark summoner who commands Osty and raises undead minions. Manipulates souls and sacrifices allies for power.': { ja: 'オスティを従え、アンデッドミニオンを召喚するダークサモナー。魂を操り仲間を犠牲に力を得る。', ko: '오스티를 지휘하고 언데드 미니언을 소환하는 어둠의 소환사. 영혼을 조종하고 아군을 희생시켜 힘을 얻음.', zh: '指挥奥斯提并召唤亡灵仆从的暗黑召唤师。操纵灵魂，牺牲盟友获取力量。', de: 'Ein dunkler Beschwörer, der Osty befehligt und Untote herbeiruft. Manipuliert Seelen und opfert Verbündete für Macht.', fr: 'Un invocateur sombre qui commande Osty et lève des morts-vivants. Manipule les âmes et sacrifie des alliés pour le pouvoir.', es: 'Un invocador oscuro que comanda a Osty y levanta no-muertos. Manipula almas y sacrifica aliados por poder.', pt: 'Um invocador sombrio que comanda Osty e ergue mortos-vivos. Manipula almas e sacrifica aliados por poder.', it: 'Un evocatore oscuro che comanda Osty e risveglia non-morti. Manipola anime e sacrifica alleati per potere.', pl: 'Mroczny przywoływacz dowodzący Ostym i wskrzeszający nieumarłych. Manipuluje duszami i poświęca sojuszników dla mocy.', ru: 'Тёмный призыватель, командующий Ости и поднимающий нежить. Манипулирует душами и жертвует союзниками ради силы.', tr: 'Osty\'yi yöneten ve ölümsüz uşaklar çağıran karanlık büyücü. Ruhları manipüle eder ve güç için müttefikleri feda eder.', th: 'ผู้เรียกมืดที่บัญชาออสตีและปลุกมินเนียนอันเดด ควบคุมวิญญาณและเสียสละพันธมิตรเพื่อพลัง' },
  'A celestial ruler who harnesses Stars for powerful abilities. Balances resource management with explosive turns.': { ja: '星の力を操る天上の支配者。リソース管理と爆発的なターンのバランスを取る。', ko: '별의 힘을 다루는 천상의 통치자. 자원 관리와 폭발적인 턴의 균형.', zh: '驾驭星辰之力的天界统治者。在资源管理与爆发回合间取得平衡。', de: 'Ein himmlischer Herrscher, der Sterne für mächtige Fähigkeiten nutzt. Balance zwischen Ressourcenmanagement und explosiven Runden.', fr: 'Un souverain céleste qui exploite les Étoiles pour des capacités puissantes. Équilibre entre gestion des ressources et tours explosifs.', es: 'Un gobernante celestial que aprovecha las Estrellas. Equilibra la gestión de recursos con turnos explosivos.', pt: 'Um governante celestial que usa Estrelas para habilidades poderosas. Equilibra gestão de recursos com turnos explosivos.', it: 'Un sovrano celeste che sfrutta le Stelle per abilità potenti. Bilancia gestione risorse e turni esplosivi.', pl: 'Niebiański władca wykorzystujący Gwiazdy do potężnych zdolności. Równoważy zarządzanie zasobami z wybuchowymi turami.', ru: 'Небесный правитель, использующий Звёзды для мощных способностей. Баланс между управлением ресурсами и взрывными ходами.', tr: 'Güçlü yetenekler için Yıldızları kullanan göksel hükümdar. Kaynak yönetimi ile patlayıcı turlar arasında denge kurar.', th: 'ผู้ปกครองสวรรค์ที่ใช้ดาวเพื่อความสามารถอันทรงพลัง สมดุลระหว่างการจัดการทรัพยากรกับเทิร์นระเบิด' },
